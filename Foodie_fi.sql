...
ALTER TABLE plans MODIFY price DECIMAL(10, 2) NULL;
...
/*Questions.
A. Customer journey
Q1. Based off the 8 sample customers provides in the sample from
the subscriptions table, write a brief description about each
customers onboarding journey.*/
select
s.customer_id,
p.plan_name,
s.start_date
...
values for our dataset - use the start of the month as the group
by value.*/
SELECT
...
/*Q3. what paln start_date values occur after the year 2020 for
our dataset?Show the breakdown by count of events for each plan_name*/
select
p.plan_name,
p.plan_id,
...
/*Q4. What is the customer count and % of customers who have 
...
FROM
  ...
  /*Q5. How many customers have churned straight after their initia;
  free trial - what % is this rounded to the nearest whole number?
*/
with ranked_cte as(
select
sub.customer_id,
...
/*Q6. What is the number and percentage of customer plans after
...
/*Q7. What is the customer count and percentage breakdown of all
...
/*Q9. How many customers downgraded from a pro monthly to a basic monthly plan in 2020?
*/
